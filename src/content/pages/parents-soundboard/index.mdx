...
<div className="flex justify-between">
  <AppStoreButton store="ios" url={config.projects[3].urls.appStore}></AppStoreButton>
  <AppStoreButton store="android" url={config.projects[3].urls.googlePlay}></AppStoreButton>
</div>
