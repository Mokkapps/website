...
<Button
  onClick={() => {
    ...
    alert('You successfully disabled collecting analytics data!');
  }}
>
  Do not track
</Button>

Mokkapps uses [BuySellAds](https://www.buysellads.com/) to show ads on the website. They don't collect any sensitive information, more information can be found [here](https://content.buysellads.com/publishers/what-data-does-buysellads-collect). They will use the IP address and useragent to set the campaign targeting, but they're not storing them for fingerprinting/retargeting.
